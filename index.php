...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Begin Page Content -->
              <!-- Content Row -->
     <!-- Buat Buka webcam capture camera  -->
	<div class="col-auto menu2">
        <div class="card border-left-primary shadow">
            <div class="card-body">
                <a class="row no-gutters align-items-center" href="webcam_1.php">
                    <div class="col mr-2">
                        <div class="h6 text-xs font-weight-bold text-dark ">Webcam Capture Camera</div>
   ...
   <br>
   <!-- Buat Buka Webcam dengan ada marker/deteksi wajah  -->
   <div class="col-auto menu2">
        <div class="card border-left-primary shadow">
            <div class="card-body">
                <a class="row no-gutters align-items-center" href="webcam_2.php">
                    <div class="col mr-2">
                        <div class="h6 text-xs font-weight-bold text-dark">Webcam Capture Camera Marker</div>
                        <div class="h6 font-weight-bold text-gray-800">
                           Pilih
                        </div>
                    </div>
